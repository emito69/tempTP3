...
contract SwapVerifier {
    ...
    function verify(
        ...
        console.log("EMII BALANCE 00000000000A :", IERC20(tokenA).balanceOf(address(swapContract)));
        console.log("EMII BALANCE 00000000000B :", IERC20(tokenB).balanceOf(address(swapContract)));
        IERC20(tokenA).approve(swapContract, amountA);
        console.log("EMII APPPROVE 00000000000A :", IERC20(tokenA).allowance(address(this), swapContract));
        IERC20(tokenB).approve(swapContract, amountB);
        console.log("EMII APPPROVE 00000000000B :", IERC20(tokenA).allowance(address(this), swapContract));
